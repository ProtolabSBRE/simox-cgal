...
#define BOOST_TEST_MODULE SimoxCGAL_SimoxCGALSurfaceMeshTest
...
BOOST_AUTO_TEST_SUITE(SimoxCGALSurfaceMesh)
...
BOOST_AUTO_TEST_CASE(testSurfaceMeshIO)
{
    ...
    CGALSurfaceMeshPtr tmc2 = CGALMeshIO::LoadSurfaceMesh(fn);
    BOOST_REQUIRE(tmc2);
